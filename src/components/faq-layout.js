...
const FAQLayout = ({ data }) => (
  <Layout>
    <SEO
      title="FAQ | Frezh - air quality tracker"
    ...
    <div>
      ...
      >
        <h2 style={{ marginBottom: 10, fontSize: 23 }}>
          {data.article.frontmatter.title}
        </h2>
        <p style={{ color: "#666", lineHeight: "22px" }}>
          {data.article.frontmatter.description}
        </p>
        <div
          style={{
            height: 2,
        ...
        />
        <Content dangerouslySetInnerHTML={{ __html: data.article.html }} />
